...
class AppColors {
  ...
  static Color primaryGray = const Color(0xFFA4A4A4);
  static Color secondaryGray = const Color(0xFFEDEDED);
  static Color tertiaryGray = const Color(0xFFD9D9D9);
  static Color tertiaryDefaultLight = const Color(0xFF666666);
  ...
  static Color highSakuraLight = const Color(0xFFFB6F92);
  static Color mediumSakuraLight = const Color(0xFFFFB3C6);
  static Color lowSakuraLight = const Color(0xFFFFE5EC);
  static Color tertiarySakuraLight = const Color(0xFF947D66);
  ...
  static Color highOrangeLight = const Color(0xFFF09B61);
  static Color mediumOrangeLight = const Color(0xFFFBC077);
  static Color lowOrangeLight = const Color(0xFFD9EED9);
  static Color tertiaryOrangeLight = const Color(0xFF8D745C);
