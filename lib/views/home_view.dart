...
class _HomeViewState extends State<HomeView> {
  ...
  void _loadUserData() async {
    ...
    setState(() {
      ...
      userGoal = Goal.values[prefs.getInt('userGoal') ??
          Goal.productivity.index]; // Use default value if not found
      preferredMethod = PreferredMethod.values[prefs
              .getInt('preferredMethod') ??
          PreferredMethod.traditional.index]; // Use default value if not found
    });
  }
                  ...
                  builder: (BuildContext context) {
                    return Center(
                      child: CustomModalWidget(
                        ...
                        onButtonPressed: () {
                          Navigator.of(context)
                              .push(CustomPageRoute(NewDayView()));
                        },
                      ),
                    );
                  },
